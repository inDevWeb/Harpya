...
class HStandardSeek extends HWindow
{
    ...
    public function __construct()
    {
        ...
        $find_button->setImage('fa:search text-primary');
        ...
        $this->pageNavigation = new HPageNavigation;
    ...
    public function render()
    {
        ...
        $action1->setLabel('');
        $action1->setImage('fa:hand-pointer-o text-success');
